    ...
    <div style="display:flex; flex-direction:column; flex:1;">
      <div style="position: relative; display: flex; flex: 1; padding: 72px;">
        <div style="display:flex; align-items:center; gap:36px; width:100%;">
          ...
          >
            <svg viewBox="0 0 797 693" width="160" height="140" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        <div
          style="display:flex; font-family: 'SF Pro Rounded'; font-weight: 500; font-size: 24px; color: #475569;"
        >
          ${dates}
        </div>
        <div
